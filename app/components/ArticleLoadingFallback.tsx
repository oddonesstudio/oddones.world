  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex w-full max-w-3xl flex-col items-center gap-5 px-6 text-center">
      ...
      <div className="z-20 w-full rounded-lg bg-white pb-(--footer-height)">
