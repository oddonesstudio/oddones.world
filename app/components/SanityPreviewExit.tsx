...
export function SanityPreviewExit() {
  ...
  return (
    <div className="fixed top-4 left-1/2 z-[1000] flex -translate-x-1/2 items-center gap-3 border-2 border-black bg-page-background px-4 py-3 text-page-foreground shadow-custom">
